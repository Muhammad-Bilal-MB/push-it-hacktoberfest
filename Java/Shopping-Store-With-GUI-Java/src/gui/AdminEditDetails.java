 ...
 * @author xxhackerxx
 */
public class AdminEditDetails extends javax.swing.JFrame {

    Admin admin;

    public AdminEditDetails(Admin admin) {
        this.admin = admin;
        initComponents();
    }
    ...
    ContactNoField.setText(admin.getContactNo());
    ...
    admin.editDetails(name, password, emailAddress, address, String.valueOf(contactNo));
