 ...
 * @author xxhackerxx
 */
public class SellerViewSoldItems extends javax.swing.JFrame {
     ...
     * @param seller
     */
    public SellerViewSoldItems(Seller seller) {
        this.seller = seller;
        initComponents();
    }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        for (Item item : items) {
            ...
            SoldItems.setText(SoldItems.getText() + "Item title: " + item.getItemTitle() + "<br>" + "Item Describtion: " + item.getItemDescribtion() + "<br>" + "Item Price: " + item.getItemPrice() + "<br>" + "Item Category: " + item.getItemCategory() + "<br>"  +  "Method of delivery: " + item.getMethodOfDelivery() +"<br>" + "Success fees Deducted: " + item.getSuccessFees()+"<br>" +"================================================="+"<br>");
        }
